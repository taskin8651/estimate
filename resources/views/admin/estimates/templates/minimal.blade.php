<div class="w-full bg-gray-100 py-4 px-3">
    ...
    <div class="w-full max-w-4xl mx-auto bg-white border border-gray-300 rounded-lg shadow-sm overflow-hidden">
        ...
        {{-- ================= CLIENT + ESTIMATE ================= --}}
        <div class="grid grid-cols-2 gap-6 px-6 py-5 border-b border-gray-300 text-xs">
            ...
            <div class="flex justify-end">
                <div class="w-60 p-4 border border-gray-300 bg-gray-50 text-[11px]">
        ...
        <div class="flex justify-end px-6 pb-6">
            ...
            <div class="w-60 border border-gray-300 p-4 bg-gray-50 text-xs">
                ...
                <div class="flex justify-between py-2 border-t border-gray-300 font-semibold text-sm text-gray-800">
                    <span>Total</span>
