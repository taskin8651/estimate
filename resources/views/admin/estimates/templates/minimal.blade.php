<div class="max-w-6xl mx-auto bg-white rounded shadow overflow-hidden">
    ...
    {{-- ================= TOP HEADER ================= --}}
    <div class="flex justify-between items-center px-10 py-8 border-b border-gray-200">
        ...
        <div class="text-right text-sm text-gray-500 leading-6">
    ...
    <div class="grid grid-cols-2 gap-10 px-10 py-8 border-b border-gray-200">
        ...
        <div class="flex justify-end">
            <div class="w-72 p-6 rounded border border-gray-200 bg-gray-50">
    ...
    <div class="px-10 py-8">
        ...
        <table class="w-full text-sm border-collapse">
            ...
            <thead class="border-b border-gray-200 text-gray-600">
                <tr>
                    <th class="py-3 text-left font-medium">Services</th>
                    <th class="py-3 text-right font-medium">Qty</th>
                    <th class="py-3 text-right font-medium">Rate</th>
    ...
    <div class="px-10 pb-10 border-t border-gray-200">
        ...
        <h4 class="text-xs uppercase text-gray-400 font-semibold mb-3">
            Notes
        </h4>
