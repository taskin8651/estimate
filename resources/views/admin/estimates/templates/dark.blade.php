<div class="w-full bg-gray-950 py-4 px-3">

    <div class="w-full max-w-4xl mx-auto bg-gray-900 text-gray-200 
                border border-gray-800 rounded-xl shadow-2xl overflow-hidden">
        ...
        {{-- ================= CLIENT + ESTIMATE ================= --}}
        <div class="grid grid-cols-2 gap-6 px-6 py-5 border-b border-gray-800 text-xs">
            ...
            <div class="flex justify-end">
                <div class="w-60 p-4 bg-gray-800 border border-gray-700 rounded text-[11px]">
                    ...
                    <div class="border-t border-gray-700 mt-3 pt-2 text-right">
        ...
        <div class="px-6 py-5">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-xs border border-gray-800 border-collapse">

                    <thead class="bg-gray-800 text-gray-300 text-[12px]">
                        <tr>
                            <th class="p-2 border border-gray-700 text-left font-semibold">
                                Services
                            </th>
                            <th class="p-2 border border-gray-700 text-right font-semibold">
                                Qty
                            </th>
                            <th class="p-2 border border-gray-700 text-right font-semibold">
                                Rate
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-800 transition">
                            ...
                            <td class="p-2 border border-gray-800 text-right">
                                {{ $item->quantity }}
                            </td>
                            ...
                            <td class="p-2 border border-gray-800 text-right font-semibold text-indigo-400">
        ...
        <div class="flex justify-end px-6 pb-6">
            ...
            <div class="w-60 border border-gray-800 p-4 bg-gray-800 text-xs rounded">
                ...
                <div class="flex justify-between py-2 border-t border-gray-700 font-bold text-sm text-indigo-400">
                    <span>Total</span>
