...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">
            Update your SMTP credentials.
        </p>
    </div>

    <div class="bg-white shadow rounded-lg border border-gray-200 p-6">

        <form method="POST" action="{{ route('admin.mail-settings.update', $setting->id) }}">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="encryption"
                        ...
                        <option value="tls" {{ $setting->encryption == 'tls' ? 'selected' : '' }}>
                            TLS
                        </option>

                        <option value="ssl" {{ $setting->encryption == 'ssl' ? 'selected' : '' }}>
                            SSL
                        </option>
